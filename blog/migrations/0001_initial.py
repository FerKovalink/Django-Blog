# Generated by Django 4.0.3 on 2022-04-24 00:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=300, unique=True, verbose_name='Link')),
                ('status', models.IntegerField(choices=[(0, 'Borrador'), (1, 'Publicado')], default=0, verbose_name='Estado')),
